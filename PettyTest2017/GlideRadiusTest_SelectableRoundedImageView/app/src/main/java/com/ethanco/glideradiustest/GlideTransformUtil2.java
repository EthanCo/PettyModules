 ...
 * @since 2017/5/2
 */
public class GlideTransformUtil2 extends BitmapTransformation {

    private static float radius = 0f;

    public GlideTransformUtil2(Context context) {
        this(context, 4);
    }

    public GlideTransformUtil2(Context context, int dp) {
        super(context);
