...
public class DirectionCompat {
     ...
     * @return
     */
    public static String getCustemDir(Context context, String folder) {
        String dir;
     ...
     * @return
     */
    public static String getCustemDir(Context context, String folder, String folderChild) {
        String dir = getCustemDir(context, folder);
