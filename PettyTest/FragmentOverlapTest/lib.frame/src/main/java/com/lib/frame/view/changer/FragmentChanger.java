...
public class FragmentChanger implements IFragmentChanger, IFragmentSave {
    ...
    private static final String KEY_CURR_FRAGMENT_TAG = "fragment_curr_tag";
    private static final String TAG = "Z-FragmentChanger";
    ...
    public void restoreInstanceState(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            ...
            resetCurrTag(savedInstanceState);
            resetFragmentUI();
        }
    }
    ...
    public void saveInstanceState(Bundle outState) {
        ...
        outState.putString(KEY_CURR_FRAGMENT_TAG, currFragmentTag);
    }
    ...
    public void changeFragment(Fragment fragment, int containerViewId, String isBackStack, boolean useCache) {
        changeFragment(fragment, getFragmentTag(fragment), containerViewId, isBackStack, true);
    }
    ...
    private void resetFragmentUI() {
        ...
        for (String tag : tagList) {
            ...
            if (tag.equals(currFragmentTag)) {
                Log.i(TAG, "resetFragmentUI show " + fragment.getClass().getSimpleName());
                transformation.show(fragment);
            } else {
                Log.i(TAG, "resetFragmentUI hide " + fragment.getClass().getSimpleName());
    ...
    private void resetCurrTag(Bundle savedInstanceState) {
        currFragmentTag = savedInstanceState.getString(KEY_CURR_FRAGMENT_TAG);
    }
