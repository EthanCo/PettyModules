...
//        Bitmap bmp = Compressor.getDefault(this)
//                .compressToBitmap(new File("file:///android_res/bg1.jpeg"));

        //File file = new File(Environment.getExternalStorageDirectory(), "bg3.jpg");
        File file = null;
        //file = new File(getAssets().list("")[0]);
        //file = new File("file:///android_asset/bg3.jpg");
        file = new File("http://h5.86.cc/walls/20141222/1440x900_6fcf55e888cbe77.jpg");
        Log.i("Z-", "path:" + file.getPath());

        Bitmap bmp = new Compressor.Builder(this)
                .setMaxWidth(640)
                .setMaxHeight(480)
                .setQuality(75)
                ...
                .build()
                //file:///android_res/drawable/bg1.jpeg
                //.compressToBitmap(new File("file:///android_asset/bg3.jpg"));
                //.compressToBitmap(new File(getAssets().getLocales()[0]));
