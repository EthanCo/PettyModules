...
package com.lib.utils.validate;
...
public class RegexUtil {
    ...
    /**
     * 验证手机号码（支持国际格式，+86135xxxx...（中国内地），+00852137xxxx...（中国香港））	 * @param mobile 移动、联通、电信运营商的号码段	 *
     ...
     * 密码6-20位字符
     */
    public static boolean checkMiguPassWord(String passWord) {
        String regex = "^[^\\s]{6,20}$ ";
