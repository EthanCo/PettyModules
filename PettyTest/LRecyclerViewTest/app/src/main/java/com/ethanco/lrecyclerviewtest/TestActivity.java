...
import com.ethanco.lrecyclerviewtest.databinding.ActivityTestBinding;
...
public class TestActivity extends AppCompatActivity {
    ...
    private void requestData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                if (NetworkUtil.isNetAvailable(TestActivity.this)) {
    ...
    private static class PreviewHandler extends Handler {
        ...
        private WeakReference<TestActivity> ref;

        PreviewHandler(TestActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final TestActivity activity = ref.get();
